...
class TurtleController(Node):
    ...
    def send_turtle1_velocity(self):
        self.turtle1_publisher.publish(self.turtle1_velocity)
        self.get_logger().info('Turtle1 - Publishing: linear.x: {:.2f}, angular.z: {:.2f}'.format(self.turtle1_velocity.linear.x, self.turtle1_velocity.angular.z))

    def send_turtle2_velocity(self):
        self.turtle2_publisher.publish(self.turtle2_velocity)
        self.get_logger().info('Turtle2 - Publishing: linear.x: {:.2f}, angular.z: {:.2f}'.format(self.turtle2_velocity.linear.x, self.turtle2_velocity.angular.z))
